...
<div class="card p-4 shadow-sm" style="border-radius: 40px 0px 40px 0px; max-width: 480px; margin: 0 auto; border: 1px solid #e0e0e0;">
    <h2 class="text-center text-secondary mb-3" style="font-family: sans-serif; font-weight: 400;">
        Form<span style="color: #f0a030;">Computer</span>
    </h2>
    ...
    <form action="{{route('computer.store')}}" method="POST">
        ...
        <div class="mb-3">
            <label for="full_name" class="form-label fw-semibold text-secondary small" >Numero del computador:</label>
            <div class="input-group shadow-sm-inset">
                ...
                <input type="number" name="number" id="number" class="form-control border-start-0 ps-1" placeholder="Número">
            </div>

            <div class="mb-3">
            <label for="full_name" class="form-label fw-semibold text-secondary small" >Marca :</label>
            <div class="input-group shadow-sm-inset">
                <span class="input-group-text bg-white text-muted border-end-0"> <i class="bi bi-caret-right-fill"></i></span>
                <input type="text" name="brand" id="brand" class="form-control border-start-0 ps-1" placeholder="Marca">
            </div>
